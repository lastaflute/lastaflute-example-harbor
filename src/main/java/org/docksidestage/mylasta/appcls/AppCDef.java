...
public interface AppCDef extends Classification {
    ...
    public enum SearchMemberStatus implements AppCDef {
        ...
        private SearchMemberStatus(String code, String alias) { _code = code; _alias = alias; }
         ...
         */
        public static SearchMemberStatus codeOf(Object code) { return _slimmer.codeOf(code); }
        /**
         ...
         */
        public static SearchMemberStatus nameOf(String name) { return _slimmer.nameOf(name, nm -> valueOf(nm)); }
        /**
         ...
         */
        public static List<SearchMemberStatus> listOf(Collection<String> codeList) { return _slimmer.listOf(codeList); }
        /**
    ...
    public enum DefMeta implements ClassificationMeta {
        /** MemberStatus for search condition */
        SearchMemberStatus(cd -> AppCDef.SearchMemberStatus.of(cd), nm -> AppCDef.SearchMemberStatus.byName(nm)
        , () -> AppCDef.SearchMemberStatus.listAll(), gp -> AppCDef.SearchMemberStatus.listByGroup(gp)
